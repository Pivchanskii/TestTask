...
const Registry = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            repeatpassword: Yup.string().matches(password, 'Введенные данные должны совпадать с паролем').required('Обязательное поле')
        }),
        ...
        <div className={s.box}>
            <div className={s.boxInner}>
                ...
                <form className={s.form} onSubmit={formik.handleSubmit}>
                    ...
                    <div className={s.container}>
                        <TextField error={!!(formik.touched.repeatpassword && formik.errors.repeatpassword)} name='repeatpassword'
                                   helperText={(formik.touched.repeatpassword && formik.errors.repeatpassword) && formik.errors.repeatpassword}
                                   value={formik.values.repeatpassword} onChange={formik.handleChange} onBlur={formik.handleBlur}
                                   label='Повторите пароль' type="repeatpassword" variant={'standard'} size={'small'}/>
                    </div>
